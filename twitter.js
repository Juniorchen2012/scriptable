...
try{
console.log(resp.data.lv_identifier)
}catch{
  resp= await get({url:`https://counts.live/api/twitter-follower-count/${twitter}/data`,headers:{"Cookie": "__cfduid=d0e779c9e83b5126547bd5f43991b41da1606145300","Referer":`https://counts.live/twitter-follower-count/${twitter}`}})
}
